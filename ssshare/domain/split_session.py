...
class SplitSession(DomainObject):
    ...
    @classmethod
    def get(cls, session_id: str, auth: str=None, repo=secret_share_repository) -> 'SplitSession':
